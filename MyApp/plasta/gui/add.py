...
#################
    ...
    def showSearcher(self):
        ...
        search.alignmentColumns = self.searcher_alignmentColumns
        search.ATRI_COMBO_BUSQUEDA = self.searcher_ATRI_COMBO_BUSQUEDA
        search.ATRIBUTOSLISTA = self.searcher_ATRIBUTOSLISTA
        search.exec_()
